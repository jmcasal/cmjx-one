...
namespace xone
{
    ...
    [Guid(xonePackage.PackageGuidString)]
    [ProvideMenuResource("Menus.ctmenu", 1)]
    public sealed class xonePackage : AsyncPackage
    {
        /// <summary>
        /// xonePackage GUID string.
        /// </summary>
        public const string PackageGuidString = "a67ab690-a4e5-4343-88a9-bec3daea81db";

        private static readonly object _s_applicationLock = new object();
        public static DTE Application { get; private set; }
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await XOneRenameWindow.InitializeAsync(this);
